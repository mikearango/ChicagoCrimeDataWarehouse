...
package chicago_crime.junk_0_1;
...
/**
 * Job: Junk Purpose: Load the Junk Table<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.3.1.20161216_1026
 * @status 
 */
public class Junk implements TalendJob {
	...
	private final String jobName = "Junk";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Junk.this, new Object[] { e,
	...
	public static class JunkStruct implements
			routines.system.IPersistableRow<JunkStruct> {
		final static byte[] commonByteArrayLock_CHICAGO_CRIME_Junk = new byte[0];
		static byte[] commonByteArray_CHICAGO_CRIME_Junk = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.Junk_Key == null) ? 0 : this.Junk_Key
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final JunkStruct other = (JunkStruct) obj;

			if (this.Junk_Key == null) {
				if (other.Junk_Key != null)
					return false;

			} else if (!this.Junk_Key.equals(other.Junk_Key))
		...
		public void copyDataTo(JunkStruct other) {
		...
		public void copyKeysDataTo(JunkStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CHICAGO_CRIME_Junk) {
		 ...
		 * Compare keys
		 */
		public int compareTo(JunkStruct other) {
	...
	public static class row1Struct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CHICAGO_CRIME_Junk.length) {
					if (length < 1024
							&& commonByteArray_CHICAGO_CRIME_Junk.length == 0) {
						commonByteArray_CHICAGO_CRIME_Junk = new byte[1024];
					} else {
						commonByteArray_CHICAGO_CRIME_Junk = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CHICAGO_CRIME_Junk, 0, length);
				strReturn = new String(commonByteArray_CHICAGO_CRIME_Junk, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
	...
	public void tFileInputExcel_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				JunkStruct Junk = new JunkStruct();
				...
				class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime
									* result
									+ ((this.Arrest == null) ? 0 : this.Arrest
											.hashCode());

							result = prime
									* result
									+ ((this.Domestic == null) ? 0
											: this.Domestic.hashCode());

							result = prime
									* result
									+ ((this.Junk_Key == null) ? 0
											: this.Junk_Key.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.Arrest == null) {
							if (other.Arrest != null)
								return false;
						} else if (!this.Arrest.equals(other.Arrest))
							return false;

						if (this.Domestic == null) {
							if (other.Domestic != null)
								return false;
						} else if (!this.Domestic.equals(other.Domestic))
							return false;
					...
					if (sheetList_tFileInputExcel_1.size() > 0) {
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							if (row1 != null) {
								...
								operation_finder_tAggregateRow_1.Arrest = row1.Arrest;
								operation_finder_tAggregateRow_1.Domestic = row1.Domestic;
								operation_finder_tAggregateRow_1.Junk_Key = row1.Junk_Key;
								...
								if (operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
									...
									operation_result_tAggregateRow_1.Arrest = operation_finder_tAggregateRow_1.Arrest;
									operation_result_tAggregateRow_1.Domestic = operation_finder_tAggregateRow_1.Domestic;
									operation_result_tAggregateRow_1.Junk_Key = operation_finder_tAggregateRow_1.Junk_Key;
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("Junk" + iterateId, 0, 0);
				...
				String tableName_tMysqlOutput_1 = "Junk";
				...
				while (rsTable_tMysqlOutput_1.next()) {
					...
					if (table_tMysqlOutput_1.equalsIgnoreCase("Junk")) {
				...
				stmtCreate_tMysqlOutput_1
						.execute("CREATE TABLE `"
								+ tableName_tMysqlOutput_1
								+ "`(`Junk_Key` INT(10)  ,`Arrest_Code` BIT(5)  ,`Domestic_Code` BIT(5)   not null ,primary key(`Junk_Key`))");
				stmtCreate_tMysqlOutput_1.close();

				String insert_tMysqlOutput_1 = "INSERT INTO `"
						+ "Junk"
						+ "` (`Junk_Key`,`Arrest_Code`,`Domestic_Code`) VALUES (?,?,?)";
				...
				JunkStruct Junk_tmp = new JunkStruct();
				// ###############################
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row2.Arrest = aggregated_row_tAggregateRow_1.Arrest;

					row2.Domestic = aggregated_row_tAggregateRow_1.Domestic;

					row2.Junk_Key = aggregated_row_tAggregateRow_1.Junk_Key;
					...
					{ // start of Var scope
						...
						// # Output table : 'Junk'
						Junk_tmp.Junk_Key = row2.Junk_Key;
						Junk_tmp.Arrest_Code = row2.Arrest;
						Junk_tmp.Domestic_Code = row2.Domestic;
						Junk = Junk_tmp;
						// ###############################
					...
					if (Junk != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection("Junk" + iterateId,
									1, 1);
						}

						whetherReject_tMysqlOutput_1 = false;
						if (Junk.Junk_Key == null) {
							pstmt_tMysqlOutput_1.setNull(1,
									java.sql.Types.INTEGER);
						} else {
							pstmt_tMysqlOutput_1.setInt(1, Junk.Junk_Key);
						}

						if (Junk.Arrest_Code == null) {
							pstmt_tMysqlOutput_1.setNull(2,
									java.sql.Types.BOOLEAN);
						} else {
							pstmt_tMysqlOutput_1
									.setBoolean(2, Junk.Arrest_Code);
						}

						pstmt_tMysqlOutput_1.setBoolean(3, Junk.Domestic_Code);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null
							|| !((Boolean) resourceMap.get("inIterateVComp"))) {
						runStat.updateStatOnConnection("Junk" + iterateId, 2, 0);
					}
				}
	...
	public static void main(String[] args) {
		final Junk JunkClass = new Junk();

		int exitCode = JunkClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Junk.class.getClassLoader()
					.getResourceAsStream(
							"chicago_crime/junk_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Junk");
		}
...
/************************************************************************************************
 * 89340 characters generated by Talend Open Studio for Data Integration on the
 * May 3, 2017 3:35:33 PM EDT
 ************************************************************************************************/
